...
import type { AudioZoneStatus } from '../../models/AudioZone.js'
import type { OmniLinkPlatform } from '../../platform.js'

import { OmniObjectStatusTypes } from '../../models/OmniObjectBase.js'
import { AudioZoneCommandStates } from '../../omni/messages/enums.js'
import { HomekitAccessoryBase } from './HomekitAccessoryBase.js'

export class AudioZoneTelevision extends HomekitAccessoryBase {
