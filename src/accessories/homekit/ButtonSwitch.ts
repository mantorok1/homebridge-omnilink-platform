...
import { OmniObjectStatusTypes } from '../../models/OmniObjectModel.js'
import { HomekitAccessoryBase } from './HomekitAccessoryBase.js'

export class ButtonSwitch extends HomekitAccessoryBase {
  constructor(
  ...
  setEventHandlers(): void {
    ...
    this.platform.omniService.on(this.platform.omniService.getEventKey(OmniObjectStatusTypes.Button, this.platformAccessory.context.index), this.updateValues.bind(this))
  }
