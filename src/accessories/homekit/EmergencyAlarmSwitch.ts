...
export class EmergencyAlarmSwitch extends HomekitAccessoryBase {
  ...
  setEventHandlers(): void {
    ...
    this.platform.omniService.on(this.platform.omniService.getEventKey(OmniObjectStatusTypes.Area, this.areaId), this.updateValues.bind(this))
  }
