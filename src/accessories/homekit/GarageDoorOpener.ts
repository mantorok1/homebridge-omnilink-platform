...
export class GarageDoorOpener extends HomekitAccessoryBase {
  ...
  setEventHandlers(): void {
    ...
    if (this.zoneId !== undefined) {
      this.platform.omniService.on(this.platform.omniService.getEventKey(OmniObjectStatusTypes.Zone, this.zoneId), this.updateValues.bind(this))
    }
  }
