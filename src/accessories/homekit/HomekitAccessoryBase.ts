...
export abstract class HomekitAccessoryBase {
  ...
  setAccessoryInformation(): void {
    ...
    service
      ...
      .setCharacteristic(this.platform.Characteristic.Model, this.platform.omniService.omni.information.model)
      .setCharacteristic(this.platform.Characteristic.SerialNumber, crypto.createHash('md5').update(this.platformAccessory.UUID).digest('hex'))
  }
