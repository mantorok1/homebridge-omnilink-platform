...
import { AudioZoneTelevision } from './AudioZoneTelevision.js'
import { ButtonSwitch } from './ButtonSwitch.js'
import { BypassZoneSwitch } from './BypassZoneSwitch.js'
import { CarbonDioxideSensor } from './CarbonDioxideSensor.js'
...
import { FanCycleSwitch } from './FanCycleSwitch.js'
import { FanOnSwitch } from './FanOnSwitch.js'
import { GarageDoorOpener } from './GarageDoorOpener.js'
import { HoldStatusSwitch } from './HoldStatusSwitch.js'
import { HumiditySensor } from './HumiditySensor.js'
import { LeakSensor } from './LeakSensor.js'
import { LockMechanism } from './LockMechanism.js'
...
import { UnitLightbulb } from './UnitLightbulb.js'
...
export class HomekitAccessoryService {
  ...
  addPlatformAccessory<TAccessory extends HomekitAccessoryBase>(
  ...
  addExternalAccessory<TAccessory extends HomekitAccessoryBase>(
    Accessory: new (platform: OmniLinkPlatform, accessory: PlatformAccessory) => TAccessory,
    type: string,
    name: string,
    index?: number,
  ...
  private addAccessory<TAccessory extends HomekitAccessoryBase>(
    Accessory: new (platform: OmniLinkPlatform, accessory: PlatformAccessory) => TAccessory,
    type: string,
    name: string,
    index?: number,
